        ...
        <div class="media-form__wrap">
            ...
            <div class="media-form__content">
                ...
                <div
                    ...
                    class="media-form__group media-form__group--input"
                    v-if="isCollection">
                    <label class="media-form__label" for="collection-items">Collection Item(s)</label>
                    <input
                        class="media-form__input"
                        id="collection-items"
                        type="text"
                        v-model.trim="collectionItems"
                        @blur="handleFocus"
                        @focus="handleFocus">
                </div>
                ...
                <div class="media-form__group media-form__group--dropdown">
                    ...
                    <select class="media-form__select" name="location" id="location" v-model="location">
                        ...
                        <option value="Junk Room">Junk Room</option>
...
export default {
    ...
    methods: {
        async submitNewMedia() {
            ...
            // If collections is true process the data and convert it into an object
            if (newMovieData.collection) {
                this.collectionItems = this.collectionItems.split(',');
                newMovieData.other = this.collectionItems;
            }
